---
title: Writeup - Sharing is Caring (irisCTF 2024)
...
This is the perfect time to discuss and analyze the files we were presented with. Inside the compressed archive were 5 files: [`1.key`](/static/irisctf-sharingiscaring/1.key), [`2.key`](/static/irisctf-sharingiscaring/2.key), [`3.key`](/static/irisctf-sharingiscaring/3.key), [`4.key`](/static/irisctf-sharingiscaring/4.key), and [`signal.txt`](/static/irisctf-sharingiscaring/signal.txt). Each of the key files were filled with 200 random bytes, no strings or magic bytes or anything.
...
I wrote a quick python script and [got Alice's key](/static/irisctf-sharingiscaring/alice.key):
...
<img src="/static/irisctf-sharingiscaring/gpt1.png" width="700px">

<img src="/static/irisctf-sharingiscaring/gpt2.png" width="700px">
...
<img src="/static/irisctf-sharingiscaring/chip.gif" width="700px">
...
I decided to use MD5 hashes of these 1600-bit variations to match to our 32 possibilities and wrote [this cool, little, script](/static/irisctf-sharingiscaring/solve.py) using perfect programming technique:
...
<img src="/static/irisctf-sharingiscaring/flag.png" width="700px">
